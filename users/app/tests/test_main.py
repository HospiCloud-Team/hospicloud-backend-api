...
from tests.test_db import override_get_db, override_get_current_user, test_db
...
def test_create_patient(test_db):
    payload = {
        ...
        "patient": {"blood_type": "a_plus"},
    }

    response = client.post(
        "/users",
        json=payload,
        headers={"Authorization": f"Bearer test.admin@gmail.com"},
    )
...
def test_update_user(test_db):
    payload = {
        ...
        "patient": {"medical_background": "This is an update!"},
    }
